...
# Health check
def healthy():
    return {"linto-platform-nlp-topic-modeling": "online"}
...
@app.post("/topic/{lang}", summary="Topic Modeling", response_model=TopicResponseModel)
def topic(lang: str, query: RequestModel):
