...
@app.route("/topic/<lang>", methods=['POST'])
def topic(lang: str):
    ...
    """
    logger.info('Topic request received')
    ...
    return {"topic": response_body}, 200
